...
describe('Mount Point Class', () => {
  ...
  it('tx-mountpoint-method.spec: check mountpoint methods callback', (done) => {
    ...
    class C1Component {      
      private mountpoint = TxMountPointRxJSRegistry.instance.create('MOUNTPOINT::METHOD::SPEC::C1');    
    ...
    let mountpoint = TxMountPointRxJSRegistry.instance.get('MOUNTPOINT::METHOD::SPEC::C1');
  ...
  it('tx-mountpoint-method.spec.ts: check multiple calls to mountpoint methods callback', (done) => {
    ...
    class C2Component {      
      private mountpoint = TxMountPointRxJSRegistry.instance.create('MOUNTPOINT::METHOD::SPEC::C2');    
    ...
    let mountpoint = TxMountPointRxJSRegistry.instance.get('MOUNTPOINT::METHOD::SPEC::C2');
